    ...
    function handleArcs (layer, data, options) {
      ...
      var path = d3.geo.path()
          ...
          //   .attr('offset', '1');
            // .call(
            //     function(gradient) {
            //       gradient.append('svg:stop').attr('offset', '0%').attr('style', 'stop-color:rgb(102, 255, 173);stop-opacity:1');
            //       gradient.append('svg:stop').attr('offset', '50%').attr('style', 'stop-color:DeepSkyBlue;stop-opacity:0.5');
            //       gradient.append('svg:stop').attr('offset', '100%').attr('style', 'stop-color:rgb(191, 255, 102);stop-opacity:0');
            //     });
      ...
      arcs
        .enter()
          ...
          // this.style.shadowBlur=200;
            // this.style.shadowColor="#fff";
        ...
        //   })
          ...
          .transition()
            ...
            //   this.style.strokeDasharray = 50+ ' ' + length;
              this.style.strokeDashoffset = length;
              this.getBoundingClientRect();
              this.style.transition = this.style.WebkitTransition = 'stroke-dashoffset ' + val(datum.animationSpeed, options.animationSpeed, datum) + 'ms ease-out';
              // this.style.transition = this.style.WebkitTransition = 'stroke-dashoffset ' + 100 + 'ms ease-out';
              // console.log(val(datum.animationSpeed, options.animationSpeed, datum));
              this.style.strokeDashoffset = '0';
            //    this.style.strokeWidth = 10;
              this.style.stroke = "url(#myGradient)";
            //    this.fillStyle = "rgba(0,0,0,0,0.1)";

            this.style.filter="url(#myFilter)"
              return 'none';
            })
